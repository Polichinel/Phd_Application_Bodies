...
\section{Cover Letter/Motivation} 
%detailing your motivation and background for applying for the specific PhD project
%(I like this on after the project description actually..) On the other side this need to serve as an introduction as well.
...
% What you apply for
The following is an application for the position as Phd. Student within the Research Project “Bodies as Battleground: Gender Images and International Security”. Specifically under the sub-project concerning the "correlation between the level of violence in armed conflict and the representation of gender in war photography"\cite{XXXX}.\par % nice to haev, but remove later

% Why you apply for this?
My motivation for applying for this scholarships is multifaceted. First of all, conflict research has been my prime politological subject of interest since even before I started my bachlor and it was one of two main focuses doing my masters program. Secondly, the other prime focus of my masters program have been advanced quantitative and computational methods. Indeed it is the intersection between modern computational methods and conflict studies which have been the focal for my whole masters program as well as my master thesis. Third.. gender stuff ... Fourth, while the I have yet to use automated image analysis in any research project, it is something that I have long wanted to undertake and something which potential could benefit a project such as this one greatly. As such my interest aligns remarkably well with the subject and methods of this project.



% What have you done before?
Appropiatly my skills match my interest. I have done this and that and my mastes thesis... said thesis I specifically use georeferenced data from UCDP in tandem with advanced machnie learning methods to predict the time and place of furture conflicts using only the past pattern of conflict... Something higly disaggregated unite of analysis... Point:

% How does this feed in to the project?

% Bridge
As such given the focus of this project and the data provided I see a near-perfect fit between this project and the abilities and interes of mine
